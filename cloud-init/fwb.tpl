...
config system vip
edit 'JUICESHOP_VIP'
set vip ${var_ipconfig2}/32
set interface port1
next
edit 'PETSTORE_VIP'
set vip ${var_ipconfig3}/32
set interface port1
next
edit 'BANK_VIP'
set vip ${var_ipconfig4}/32
set interface port1
next
end
...
edit 'server_LE_CERTIFICATE'
set domain ${var_prefix}-fwb.${var_location}.cloudapp.azure.com
...
config wvs profile
edit 'serverSCANPROFILE'
set scan-target https://${var_ipconfig1}
...
set form-based-auth-url https://${var_ipconfig1}/login.php
set username-field username
set password-field password
set session-check-url https://${var_ipconfig1}/index.php
set session-check-string Welcome
set data-format %u=%U&%p=%P
next
end
config wvs policy
edit 'serverSCANPOLICY'
set report_format html xml pdf
set profile serverSCANPROFILE
next
end
config system admin
edit 'userapi'
